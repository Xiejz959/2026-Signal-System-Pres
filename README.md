...
- support teamwork throughout the presentation process
...
This repo follows our current folder naming and keeps things simple:

- **Discuss**: discussion notes, brainstorming, and planning
- **Notebook**: notebooks and experiment records
- **Codes**: Python, MATLAB, and other supporting code
...
This repository is created for academic use in ECE0402. More detailed content, references, and presentation materials will be added as the project moves forward.

Thanks for stopping by. More signals, more systems, and probably more folders coming soon. 🙂
